...
def UpdateWoOperationStatus(WorkOrderId,IsClubbed,UserId,WorkOrderStatusId,ScanBadge,HoldReasonCodeId,Comment):
	params = {
			  "workOrderId": WorkOrderId,
			  "isClubbed": IsClubbed,
			  "param1": 0,
